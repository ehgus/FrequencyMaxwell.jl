...
@testset "Example Integration Tests" begin
    @testset "Basic Configuration Examples" begin
        # Test basic scattering solver creation (from basic_scattering.jl example)
        @test_nowarn begin
    ...
    @testset "Field Source Examples" begin
        ...
        @test_nowarn begin
            ...
            @test source_wavelength(source) ≈ solver.wavelength
        end
        ...
        @test_nowarn begin
            ...
            incident_fields = generate_incident_fields(source, solver)
    ...
    @testset "Example Integration Workflow" begin
        ...
        @test_nowarn begin
            # Step 1: Solver creation (from examples)
            solver = ConvergentBornSolver(
            ...
            phantom = phantom_bead(solver.grid_size, [1.4607^2], 3)  # SiO2 bead
